...
import time, random, sys, re,ast, os, json, subprocess, threading, string, codecs, requests, ctypes, urllib, urllib2, wikipedia,tempfile,glob,shutil,unicodedata,goslate


cl = BFFFFf.LINE()
cl.login(token="EpmyZzZGBb4VtU2ln7M0.H1Lk+IJvLIQ3rMMmhznPGa.LT+TLbnKOvWQLiGJKKhD/0FVpIB9nUM5mSILi7+Eugs=")
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = [cName + " \n [ไม่ว่างคับ กำลังแก้บอทอยู่] \n [มีอะไรทัก สต ไว้เลยคับ เดียวว่างจะมาตอบไห้คับ]"]
